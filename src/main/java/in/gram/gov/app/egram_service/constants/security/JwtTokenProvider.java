...
public class JwtTokenProvider {
    ...
    public String generateToken(Long userId, Long panchayatId, String role, String email) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("userId", userId);
        claims.put("panchayatId", panchayatId);
    ...
    public Long getPanchayatIdFromToken(String token) {
        Claims claims = getAllClaimsFromToken(token);
        return claims.get("panchayatId", Long.class);
    }
